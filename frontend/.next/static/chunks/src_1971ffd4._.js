...
"[project]/src/services/openRouterService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class OpenRouterService {
    async generateResponse(messages) {
        let model = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'openai/gpt-3.5-turbo';
        try {
            ...
            return ((_data_choices_ = data.choices[0]) === null || _data_choices_ === void 0 ? void 0 : (_data_choices__message = _data_choices_.message) === null || _data_choices__message === void 0 ? void 0 : _data_choices__message.content) || 'I apologize, I had trouble processing that request.';
        } catch (error) {
    ...
    async generateSmartResponse(userMessage, context) {
        var _context_services;
        const systemPrompt = "You are an AI receptionist for a ".concat(context.businessType || 'business', ". \nYour role is to:\n- Help customers book appointments\n- Answer questions about services and hours\n- Take messages\n- Be friendly and professional\n\nBusiness context:\n- Type: ").concat(context.businessType || 'general business', "\n- Services: ").concat(((_context_services = context.services) === null || _context_services === void 0 ? void 0 : _context_services.map((s)=>s.name).join(', ')) || 'various services', "\n- Hours: ").concat(this.formatBusinessHours(context.operatingHours), "\n\nRespond naturally and helpfully to the customer's message.");
        const messages = [
            {
                role: 'system',
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$openRouterService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/openRouterService.ts [app-client] (ecmascript)");
;
;
class AIConversationEngine {
    ...
    constructor(businessContext){
        ...
        this.openRouterService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$openRouterService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]();
    }
}
...
//# sourceMappingURL=src_1971ffd4._.js.map